...
Minimizes $\sum_p |AF(\hat{r}_p)|^2$ over the discretized directions in the specified regions, subject to the pattern constraints. The objective is quadratic; requires `QP` or `SOCP`.
